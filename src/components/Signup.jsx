...
const Signup = () => {
  // hooks using (useState) they detect change in state of the field they are used in
  ...
  // pwd-->variable that stores the written password.We can replace the name if we want
  ...
  //if we use "" it will be treated as a plain text and not a pattern matcher
  // we can also call .test() method thnx to  // and pass wht we wanna test as a parameter and it returns true or false.
    ...
    <div style={S.page}>
      ...
      <div style={S.center}>
        <div style={S.card} className="sup-card">
                  ...
                  {[
                    ...
                    >
                      <span
                        style={{
                          fontSize: "12px",
                          color: pwdChecks[key] ? "#4ade80" : "#4b5563",
                        }}
                      >
                        {pwdChecks[key] ? "✓" : "○"}
                      </span>
          ...
          <p style={S.footer}>
            Already registered?{" "}
            <Link to="/signin" className="sup-link">
              Sign in
            </Link>
          </p>
        </div>
